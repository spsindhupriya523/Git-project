...
public class VisitingController {
	...
	@PostMapping("save")
	public ResponseEntity<VisitingDto> saveVisiting(@RequestBody VisitingDto visitingDto){
		
		visitingService.saveVisiting(visitingDto);
		return ResponseEntity.ok(visitingDto);
	}
}
